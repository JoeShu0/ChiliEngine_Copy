...
namespace Bind
{
	...
	public:
		...
		static std::string GenerateUID(UINT slot = 0)
		{
			...
			//constant buffer is templated on a struct.since UID is generated by name and slot,
			//all Constant buffer templated on the same struct and in the same slot will be shared.
		}
